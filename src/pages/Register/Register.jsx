        ...
        <div className='w-2/3 mx-auto my-28 bg-gray-300 py-10'>
            ...
            <form onSubmit={handleRegister}>
                ...
                <div className='text-center'>
                    <button className='w-1/2 mx-auto bg-slate-800 text-white py-2' type="submit" name='submit'>Register</button>
                </div>                
            </form>
            
            <div className='text-center my-3 font-bold'>
            <p>Already Have an Account? <Link className='text-slate-800' to="/login">Login</Link></p>
            </div>            
        </div>
    );
};
